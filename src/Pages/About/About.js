        ...
        <Container>
            <Row>
                <Col md={8}>
                    {/* about hospital */}
                    <h3 className="mt-5">
                        {icon} Sed magna nulla, pulvinar vel ante vel, fringilla
                        vulputate nibh.
                        <br />{" "}
                        <span className="text-info">
                            In placerat facilisis tincidunt. Integer quis erat
                            dictum, placerat
                        </span>{" "}
                    ...
                    <h4 className="text-success">
                        {" "}
                        {icon2} Our Doctors are very friendly & those are very
                        talented.
                    </h4>
                    
                    <p>
                        Quisque posuere rhoncus erat, sit amet aliquet augue.
                        Nunc eleifend ornare venenatis. Mauris quis arcu et sem
                        suscipit sollicitudin at quis tellus.
                    </p>
                </Col>
