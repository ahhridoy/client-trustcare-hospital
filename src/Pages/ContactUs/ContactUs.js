                ...
                <Row>
                    <Col md={8}>
                        ...
                        <h3 className="text-info">
                            {icon} <a href="#">+0800 2336 7820</a>
                        </h3>
                        <h3 className="text-info">
                            {icon2} <a href="#">sussie.wolff@trustcare.com</a>
                        </h3>
                        <h3 className="text-info">
                            {icon3} <a href="#">Book appointment</a>
                        </h3>{" "}
                        <br /> <br />
                        <p>
                            Sed diam nonummy nibh euismod tincidunt ut laoreet
                            dolore magna aliquam erat volutpat. Quis nostrud
                            exerci tation ulla. Ut wisi enim ad minim veniam.
